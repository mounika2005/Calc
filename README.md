...
<head>
    ...
    <style>
        ...
        .button {
            ...
            color: rgb(157, 108, 247);
            border:5px solid rgb(198, 41, 233)
        }

        .button input[type="button"] {
            background-color:rgb(224, 228, 33);
            height: 50px;
            width: 50px;
            margin: 0 2px;
            border: 3px solid rgb(192, 226, 54);
        }
    </style>
</head>

<body style="background-color: rgb(104, 87, 236);">
        <h1 align="center" style="color: rgb(237, 14, 14);">SIMPLE CALCULATOR</h1>
	<h1 align="center" style="color: rgb(117, 236, 88);">LAKSHMI MOUNIKA 212223100026</h1>
        <div class="button">
            <center>
